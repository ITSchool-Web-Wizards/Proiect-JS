const apikey="d42197dab155ac7d377fdd1cf76640ce";
    ...
    if(navigator.geolocation){
        navigator.geolocation.getCurrentPosition((position)=>{
            ...
            fetch(url).then((res)=>{
                ...
                console.log(dat.toLocaleString(undefined,'Europa/Lugoj'))
...
function hourForecast(forecast){
    ...
    for (let i = 0; i < 5; i++) {
        ...
        console.log((date.toLocaleTimeString(undefined,'Europa/Lugoj')).replace(':00',''))
        ...
        time.innerText= (date.toLocaleTimeString(undefined,'Europa/Lugoj')).replace(':00','');
...
function dayForecast(forecast){
    ...
    for (let i = 8; i < forecast.list.length; i+=8) {
        ...
        day.innerText= new Date(forecast.list[i].dt*1000).toDateString(undefined,'Europa/Lugoj');
        div.appendChild(day);
